...
const App = () => {
  ...
  // Load project structure on mount if a root is set
  useEffect(() => {
    if (projectRoot) {
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden font-inter select-none">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        {/* Trae-like Activity Bar (Slim Left Bar) */}
        <ActivityBar 
          activeTab={activeTab} 
              ...
              >
                ...
                <div className="flex-1 p-4 font-mono text-[12px] text-text-main overflow-y-auto">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{projectRoot || 'C:\\Users\\mdawa\\OneDrive\\Desktop\\Trae like ai\\my-ai-editor'}&gt;</span>
